Glossary
======================
This glossary describes the components needed for the FarmBeats student kit tutorials, software tools, and defines some terminology used throughout the setup guide. 
...
A Raspberry Pi is low-cost small form factor computer that can be interfaced with a computer monitor or TV, and standard keyboard and mouse. It can be programmed to perform various task ranging from internet browsing to running complex computation.
...
Raspberry Pi OS is the official operating system for all models of the Raspberry Pi. It is based on Debian and optimised for the Raspberry Pi hardware. Raspberry Pi OS comes with precompiled software (over 35,000 packages) for easy installation.
